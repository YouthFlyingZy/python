...
a.append(5)
print(a) #[1, 2, 3, 4, ['a', 'b'], 5] #a添加一个元素5
print(b) #[1, 2, 3, 4, ['a', 'b'], 5] #b跟着添加一个元素5 
print(c) #[1, 2, 3, 4, ['a', 'b']] #c保持不变
print(d) #[1, 2, 3, 4, ['a', 'b']] #d保持不变

a[4].append('c') 
print(a) #[1, 2, 3, 4, ['a', 'b', 'c'], 5] #a中的list(即a[4])添加一个元素c
print(b) #[1, 2, 3, 4, ['a', 'b', 'c'], 5] #b跟着添加一个元素c
print(c) #[1, 2, 3, 4, ['a', 'b', 'c']] #c跟着添加一个元素c
print(d) #[1, 2, 3, 4, ['a', 'b']] #d保持不变
